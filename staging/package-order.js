...
function createWidget() {
  ...
  `;
  widget.innerHTML = `
    <img src="assets/package.svg" alt="package" style="width:100px;height:100px;display:block"/>
  ...
  for(let clip of pack) {
    html += `
      <div style="display:flex;align-items:center;padding:11px 0 7px 0;border-bottom:1.3px solid #242424;">
        ...
        <div style="flex:1;min-width:0;overflow-wrap:break-word;color:#fff;font-size:12px;font-weight:700;">${clip.title}</div>
        <button type="button" class="ae_pkg_remove" data-title="${clip.title}" style="margin-left:12px;background:#FF1A1A;border:none;color:#000;border-radius:9px;width:32px;height:32px;font-size:22px;font-weight:900;cursor:pointer;box-shadow:0 0 5px #FF1A1A80;display:flex;align-items:center;justify-content:center;line-height:1;padding-top:0px;padding-bottom:3px;text-align:center;transition:background .13s;">–</button>
      </div>
    `;
  }
